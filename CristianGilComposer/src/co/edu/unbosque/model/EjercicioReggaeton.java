...
import co.edu.unbosque.model.persistence.EjercicioFile;
import co.edu.unbosque.model.persistence.Propiedades;

public class EjercicioReggaeton {
	
	private EjercicioFile archivo;
	private Random r;
	...
	public EjercicioReggaeton() {
		archivo = new EjercicioFile();
		r = new Random();
	}
	...
	public void escribirCancion(int numero_de_estrofas, int numero_de_versos, String nombre_del_archivo) {
		...
		for (int i = 0; i < numero_de_estrofas; i++) {
			...
			for (int j = 0; j < numero_de_versos; j++) {
				cancion += parte1Verso[r.nextInt(0, 4)] + " ";
				cancion += parte2Verso[r.nextInt(0, 4)] + " ";
				cancion += parte3Verso[r.nextInt(0, 4)] + " ";
				cancion += parte4Verso[r.nextInt(0, 4)] + " ";
				cancion += parte5Verso[r.nextInt(0, 4)] + " ";
				cancion += parte6Verso[r.nextInt(0, 4)] + "\n\n";
			}
		}
	...
	public EjercicioFile getArchivo() {
		return archivo;
	}

	public void setArchivo(EjercicioFile archivo) {
